...
#define HELP_SKEL_STR                                                                                                  \
	"replaces the skeleton hierarchy with one from a .cas file\n"                                                      \
...
#define HELP_COPY_STR                                                                                                  \
	"copy a file\n"                                                                                                    \
	"usage: copy <filename> <destination>"

#define HELP_FORK_STR                                                                                                  \
	"passes the command to the system to be executed\n"                                                                \
	"usage: fork <command>\n"                                                                                          \
	"example:\n\tfork xidx -ts skeleton.idx"

#define HELP_MKDIR_STR                                                                                                 \
	"create a direcotry, similiar to mkdir -p.\naccepts both Windows and UNIX style pathnames.\n"                      \
